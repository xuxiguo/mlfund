...
# Lint as: python3
"""Custom formatting functions for Mutual Fund dataset.
...
class FundFormatter(GenericDataFormatter):
  ...
  _column_definition = [
      ('wficn', DataTypes.CATEGORICAL, InputTypes.ID),
      ('QID', DataTypes.DATE, InputTypes.TIME),
